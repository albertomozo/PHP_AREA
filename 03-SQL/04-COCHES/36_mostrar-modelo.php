...
?>
<form  name="marcas" action="36_mostrar-modelo.php" method="post" >
<label> Marca </label>
<select id="fat" name="cmarca" onChange="marcas.submit()">
...
<article>
<form  name="modelos" action="36_mostrar-modelo.php" method="post" >
<label> Modelos</label>
<select id="fo3" name="cmodelos" onChange="modelos.submit()">
