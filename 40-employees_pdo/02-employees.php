...
<?php
   ...
   {
           $emp_no = $fila['emp_no'];
            echo "<form method='post' action='02-employees_modificar.php' name='form-".$emp_no."'>";
            echo "<tr>";
            echo '<td>' . $fila['emp_no'] . '</td>';
            echo '<td>' . $fila['birth_date'] . '</td>';
            echo '<td><input type="text" name="first_name-'.$emp_no.'" id="first-name-'.$emp_no .'" value="'. $fila['first_name'] . '"></td>';
